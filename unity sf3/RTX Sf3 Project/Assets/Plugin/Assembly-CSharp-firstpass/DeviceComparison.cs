...
public class DeviceComparison : ComparisonExpression
{
	...
	public static DeviceParameter GetParameterFromString(string name)
	{
		...
		{
			Debug.LogError("DeviceComparison::GetParameterFromString - empty parameter name");
		...
		default:
			Debug.LogError(string.Format("DeviceComparison::GetParameterFromString - unknown type: {0}", name));
			return DeviceParameter.PARAMETER_NONE;
		}
	}
	...
	public void UpdateParameter()
	{
		...
		case DeviceParameter.CORES_COUNT:
			...
			break;
		default:
			Debug.LogError(string.Format("DeviceComparison::UpdateParameter - unknown type: {0}", _parameter));
			break;
		}
	}
}
