...
public class SystemProperties
{
	...
	public static bool IsMobilePlatform
	{
		get
		{
			if (Application.platform == RuntimePlatform.Android || Application.platform == RuntimePlatform.IPhonePlayer || Application.platform == RuntimePlatform.TizenPlayer)
			{
				return true;
			}
			return false;
	...
	public static float AllocatedMemory
	{
		get
		{
			return (float)Profiler.GetTotalAllocatedMemory() / 1024f;
		}
	}

	public static float MonoHeapSize
	{
		get
		{
			return (float)Profiler.GetMonoHeapSize() / 1024f;
		}
	}

	public static float MonoUsedSize
	{
		get
		{
			return (float)Profiler.GetMonoUsedSize() / 1024f;
		}
	}
	...
	internal static void Init(VersionContainer BuildVersion)
	{
		...
		string loadTextInternal = GlobalLoad.GetLoadTextInternal("DevicesQuality", string.Empty);
		initResolutionInfo(loadTextInternal);
	}
}
