...
public class UIButton : UIButtonColor
{
	...
	private Action<object> _callbackOnClick;
	...
	protected override void OnEnable()
	{
		...
		Collider = base.gameObject.GetComponent<Collider>();
	...
	public void SetCallback(Action<object> callback)
	{
		if (callback != null)
		{
			...
			EventDelegate delValue = new EventDelegate(OnCallback);
			onClick.RemoveAll((EventDelegate e) => e.Equals(delValue));
			onClick.Add(delValue);
		}
	}
	...
	public void SetImagesAtlas(UIAtlas low, UIAtlas high)
	{
		NekkiUISprite component = GetComponent<NekkiUISprite>();
		if ((bool)component)
		{
			component.SetAtlas(low, high);
			return;
		}
		UISprite component2 = GetComponent<UISprite>();
		if ((bool)component2)
		{
			Debug.Log("setup atlas " + low);
			component2.atlas = low;
		}
	}
}
