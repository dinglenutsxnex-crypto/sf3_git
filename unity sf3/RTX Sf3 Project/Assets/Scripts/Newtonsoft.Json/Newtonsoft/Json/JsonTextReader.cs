	...
	public class JsonTextReader : JsonReader, IJsonLineInfo
	{
		...
		private void ParseNumber(ReadType readType)
		{
			...
			case ReadType.ReadAsDecimal:
				...
				{
					decimal result3;
					if (!decimal.TryParse(_stringReference.ToString(), NumberStyles.Number | NumberStyles.AllowExponent, CultureInfo.InvariantCulture, out result3))
					{
			...
			default:
			{
				...
				default:
				{
					...
					{
						decimal result;
						if (!decimal.TryParse(text2, NumberStyles.Number | NumberStyles.AllowExponent, CultureInfo.InvariantCulture, out result))
						{
					...
					{
						double result2;
						if (!double.TryParse(text2, NumberStyles.Float | NumberStyles.AllowThousands, CultureInfo.InvariantCulture, out result2))
						{
